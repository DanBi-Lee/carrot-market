      ...
      <div className="px-4">
        <div className="flex items-center mt-4 space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <a href="/profile/edit" className="text-sm text-gray-700">
              Edit profile &rarr;
            </a>
          </div>
        </div>
        <div className="mt-10 flex justify-around">
          <a href="/profile/sold" className="flex flex-col items-center">
          ...
          <a href="/profile/bought" className="flex flex-col items-center">
            <div className="w-14 h-14 text-white bg-orange-400 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <a href="/profile/loved" className="flex flex-col items-center">
            <div className="w-14 h-14 text-white bg-orange-400 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
